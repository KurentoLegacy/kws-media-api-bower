...
function checkRegionOfInterest(e,n){checkType("RelativePoint",e+".points",n.points,!0),checkType("RegionOfInterestConfig",e+".regionOfInterestConfig",n.regionOfInterestConfig,!0),checkType("String",e+".id",n.id,!0)}var checkType=require("../checkType");module.exports=checkRegionOfInterest;
//# sourceMappingURL=kws-media-api.map
...
function checkRelativePoint(e,c){checkType("float",e+".x",c.x,!0),checkType("float",e+".y",c.y,!0)}var checkType=require("../checkType");module.exports=checkRelativePoint;
//# sourceMappingURL=kws-media-api.map
...
function MediaObject(e){_MediaObject.call(this,e)}var inherits=require("inherits"),_MediaObject=require("../_MediaObject");inherits(MediaObject,_MediaObject),MediaObject.prototype.getMediaPipeline=function(e){return this.invoke("getMediaPipeline",e)},MediaObject.prototype.getParent=function(e){return this.invoke("getParent",e)},MediaObject.prototype.getReadWrite=function(e){return this.invoke("getReadWrite",e)},MediaObject.prototype.getTestReadOnly=function(e){return this.invoke("getTestReadOnly",e)},MediaObject.constructorParams={},MediaObject.events=["Error"],module.exports=MediaObject,MediaObject.check=function(e,t){if(!(t instanceof MediaObject))throw SyntaxError(e+" param should be a MediaObject, not "+typeof t)};
//# sourceMappingURL=kws-media-api.map
